...
export class ItemEdit extends Component {
    ...
    savingNewItem() {
        this.props.AdminmodifyItem.bind(this, this.state.newItem);
        window.history.back();
    }
    render() {
        ...
        return (
            <div>
                    ...
                    <button  className="AdminEdittextalign adminBtnAlign" onClick={this.savingNewItem.bind(this)}> save</button><br/>
