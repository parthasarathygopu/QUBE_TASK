...
import {CompletedOrderStatus, loadAdminListItem} from '../actions/index';
import '../components/admin.css';

class OrderList extends Component {
    componentWillMount() {
        this.props.loadAdminListItem();
    }
...
function matchDispatchToProps(dispatch) {
    return bindActionCreators({ CompletedOrderStatus:CompletedOrderStatus, loadAdminListItem:loadAdminListItem}, dispatch);
}
